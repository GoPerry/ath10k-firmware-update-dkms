...
//mask old one and added new custom files by perry to support custom board bin 2017.1.4
//#define QCA6174_HW_3_0_BOARD_DATA_FILE	"board.bin"
#define QCA6174_HW_3_0_BOARD_DATA_FILE	"ath10k_board.bin"
...
//FIX ME ,just ignore the file name here,driver will call the right board file [ath10k_board.bin==board.bin]
#define ATH10K_BOARD_API2_FILE         "ath10k_board.bin"
