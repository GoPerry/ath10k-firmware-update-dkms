						   ...
						   const char *file)
{
	...
	ath10k_info(ar,"Dell : ath10k_fetch_fw_file =  %s\n",file);
...
static int ath10k_core_fetch_board_file(struct ath10k *ar)
{
...
#ifndef CONFIG_ATH10K_BOARD_CUSTOM
	1123
	ath10k_info(ar, "bd_api == 2 \n");
	ar->bd_api = 2;
...
#endif
	ar->bd_api = 1;
	ath10k_info(ar, "ath10k Loading board file with bd_api 1 \n");
	...
	ath10k_info(ar, "ath10k firmware load successfully !\n");
success:
